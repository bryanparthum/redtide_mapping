# The Value of Information and Warnings about Harmful Algal Blooms


This repo contains data and code for Yao, Moeltner and Parthum (2020), "[The Value of Information and Warnings about Harmful Algal Blooms](http://dx.doi.org/)". 
...
The main file for conducting the analysis is .R`. This will provide the primary findings in the paper. Each file is stand-alone and should be self-explanatory.
